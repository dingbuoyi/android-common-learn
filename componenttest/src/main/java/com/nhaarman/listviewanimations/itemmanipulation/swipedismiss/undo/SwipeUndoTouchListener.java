...
public class SwipeUndoTouchListener extends SwipeDismissTouchListener {
    ...
    /**
     * If necessary, notifies the {@link com.nhaarman.listviewanimations.itemmanipulation.swipedismiss.undo.UndoCallback} to remove dismissed object from the adapter,
