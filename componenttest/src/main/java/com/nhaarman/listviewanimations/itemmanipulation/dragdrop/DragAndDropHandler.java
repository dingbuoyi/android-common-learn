...
public class DragAndDropHandler implements TouchEventHandler {
    ...
    /**
     * The {@link com.nhaarman.listviewanimations.itemmanipulation.dragdrop.DraggableManager} responsible for deciding if an item can be dragged.
     */
    @NonNull
    ...
    /**
     * Sets the {@link com.nhaarman.listviewanimations.itemmanipulation.dragdrop.DraggableManager} to be used for determining whether an item should be dragged when the user issues a down {@code MotionEvent}.
     */
